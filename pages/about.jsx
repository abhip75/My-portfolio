        ...
        <div className=" mx-auto pt-16 -pb-10 max-w-7xl">
          ...
          <div className=" text-[0.92rem] md:text-base md:text-md lg:text-lg xl:text-xl mx-auto font-light dark:text-white text-gray-900 ">
            <p className="mt-6 mb-12 leading-10 font-normal">
              ...
              Experience in ReactJS, NextJS, and state management like Redux
              with proficiency in web technologies like HTML5, CSS3, and
              JavaScript, building large-scale web applications, cross-browser
